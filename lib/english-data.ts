import type { Word, GrammarRule, Idiom, SentencePattern, UserProgress, Module, Achievement } from './english-types'
...
export const levelInfo = {
  A1: { name: 'Beginner', nametr: 'Başlangıc', xpRequired: 0, color: 'bg-green-500' },
